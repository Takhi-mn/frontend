    ...
    <div className="container flex flex-col justify-center items-center w-screen gap-5 sm:gap-20">
      ...
      <div className=" w-full flex flex-col justify-center items-center  sm:flex-row-reverse sm:my-28">
        <p className="text-[14px] sm: flex-1 sm:text-base sm:min-w-[450px]">
          ...
          "Тогтвортой хөгжлийн төлөвлөгөө"-өө боловсруулсан. Ийнхүү уг сум нь 
          Завхан аймгийн хэмжээнд тогтвортой хөгжлийн бодлогоо тодорхойлсон
          анхны сум болсон бөгөөд төлөвлөгөөг  хэрэгжүүлэхэд шаардлагатай бүхий
          л дэмжлэг туслалцааг тус ТББ-аас үзүүлж байна. ТХТ нь эдийн засаг,
          нийгмийн хөгжил болон байгаль орчны тогтвортой хөгжил гэсэн үндсэн 3
          тэргүүлэх чиглэлтэй."
        </p>
      ...
      <div className="flex flex-col justify-center items-center w-full sm:flex-row">
        ...
        <div className="flex flex-col justify-center items-center w-full gap-3 sm:min-w-[450px]">
          ...
          <p className="font-[14px] sm:text-base">
            ...
            2018 онд Дөрвөлжин суманд байгуулсан. Тус "Хомын Талын Чацаргана"
            ХХК нь үйл ажиллагаагаа эхэлж, орон нутгийн зах зээлд чацарганы
            жүүс, цэвэр тос зэрэг бүтээгдхүүнээ борлуулж эхэлсэн. Нөхөрлөлүүд
            болон нутгийн иргэд Завхан голын дагуух зэрлэг чацарганы шугуйг
            хамгаалж, хураасан жимсээ үйлдвэрт нийлүүлж, орон нутгийн бизнесийн
            хөгжилд хувь нэмэр оруулан өөрсдийн ашиг орлогоо нэмэгдүүлж байна.
          </p>
          <h1 className="font-semibold text-[14px] sm:text-lg">
          ...
          <p className="font-[14px] sm:text-base">
            ...
            бүтээгдэхүүн үйлдвэрлэгчийн хооронд гурван талт гэрээ
            байгуулагдснаар 2017 оноос эхлэн Хомын талын торомны ноосыг Франц
            руу экспортлож эхэлжээ. Бран де Вьян Тиран компани нь “Хомын тал“
            хэмээх брэнд гаргасан бөгөөд уг брэндийн торомны ноосон бүтээлэг,
            алчуур зэрэг бүтээгдэхүүнийг танилцуулж, Франц болон Европын бусад
            орны зах зээлд өндөр үнэлгээ авчээ.  
          </p>
        </div>
      </div>
