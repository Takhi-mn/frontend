    ...
    <div className="bg-background text-foreground">
      ...
      <div className="flex flex-col items-center container mt-10 w-full p-6 sm:p-16 sm:px-28">
        ...
        <p className="mt-4 md:text-xl">
          ...
          sanitary facilities, showers, and restaurant, inaugurated in September
          2022, serve as a base for travelers. You will see the wild horses and
          better understand the importance of protecting them, observe fauna and
          flora in a preserved nature, between steppe, dunes, rivers and lakes
          and meet the nomads who live in the Khomyn Tal National Park. An Eco
          volunteer program is developed, for those who wish to actively help
          the rangers on a daily basis. We look forward to welcoming you and
          sharing with you our passion for Przewalski&apos;s horse and the
          beautiful landscapes of Khomyn tal.
        </p>
